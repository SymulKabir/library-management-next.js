import { getAdminToken, getStudentToken } from "@/src/utils/cookies";
...
export const checkAdminSignin = async ({ host, token: tokenInput }: CheckSigninProps): Promise<Admin | null> => {
  try {
